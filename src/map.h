...
public:
	...
	static core::aabbox3d<f32> getNodeBox(v3s16 p) {
		return core::aabbox3d<f32>((float) p.X * BS - 0.5 * BS,
	...
	void drawslope(s16 x0, s16 y0, s16 z0, s16 w, s16 h, s16 d, s16 dy_x,
			s16 dy_z, MapNode node) {
		x0 += drawoffset.X;
		y0 += drawoffset.Y;
		z0 += drawoffset.Z;
		for (u16 z = 0; z < d; z++) {
...
public:
	ClientMap(Client *client, video::SMaterial *materials,
