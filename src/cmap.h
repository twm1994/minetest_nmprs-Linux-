// TODO: find a way to read map from a json file or use serialize/deserialize utilities
#ifndef CMAP_HEADER
#define CMAP_HEADER
...
public:
  ...
  */
  ...
  // ----------change MapSector * getSectorNoGenerate(v2s16 p2d) to getSectorFromFile(v2s16 p2d)----------
  MapSector * getSectorFromFile(v2s16 p2d);
  virtual MapSector * getSector(v2s16 p);

  // ----------change MapBlock * getBlockNoCreate(v3s16 p) to MapSector * getBlockFromFile(v2s16 p2d)----------
  MapSector * getBlockFromFile(v2s16 p2d);
  virtual MapBlock * getBlock(v3s16 p);

  bool isValidPosition(v3s16 p)
  {
    // ----------TODO: Change to fetch block from local file----------
